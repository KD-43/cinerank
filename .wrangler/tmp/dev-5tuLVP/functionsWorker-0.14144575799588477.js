...
// .wrangler/tmp/pages-XgE8mK/functionsWorker-0.14144575799588477.mjs
...
async function handleCreateNewList(userId, request) {
  ...
  MOCK_DB[userId].push({ ...newListData });
  console.log(`[MOCK API]---Current data for user: ${userId[0, 3]}`, MOCK_DB[userId]);
  return new Response(JSON.stringify(newListData), {
    status: 201,
    headers: { "Content-Type": "application/json" }
  });
}
__name(handleCreateNewList, "handleCreateNewList");
__name2(handleCreateNewList, "handleCreateNewList");
async function handleUpdateExisting(userId, listId, request) {
  ...
  MOCK_DB[userLists][listIndex] = updateList;
  console.log(`[MOCK API]---Update successful: `, updateList);
  console.log(`[MOCK API]---Current state for ${userId}: `, MOCK_DB[userId]);
  return new Response(JSON.stringify(updateList), {
    status: 200,
    headers: { "Content-Type": "application/json" }
  });
}
__name(handleUpdateExisting, "handleUpdateExisting");
__name2(handleUpdateExisting, "handleUpdateExisting");
...
// .wrangler/tmp/bundle-IDn4mO/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-IDn4mO/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.14144575799588477.js.map
